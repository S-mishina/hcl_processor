...
class TestMain(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.sample_config = {
            ...
            "bedrock": {"output_json": {"type": "object"}},
        }
        ...
        self.sample_system_config = {
            ...
            "constants": {"file_processing": {"terraform_extension": ".tf"}},
        }
    ...
    def test_main_success_with_files(
        self,
        mock_reset_markdown,
        mock_setup_logger,
        mock_workflow,
        ...
        mock_reset_markdown.assert_called_once_with(
            self.sample_config["output"]["markdown_path"]
        )
        ...
        mock_workflow.assert_called_once_with(
            "test.tf", self.sample_config, self.sample_system_config
        )
    ...
    @patch("src.hcl_processor.main.setup_logger")
    @patch("src.hcl_processor.main.reset_markdown_file")
    def test_main_success_with_folder(
        self,
        mock_reset_markdown,
        mock_setup_logger,
        mock_workflow,
        ...
        # Verify reset_markdown_file is called once at the start
        mock_reset_markdown.assert_called_once_with(
            folder_config["output"]["markdown_path"]
        )
        ...
        mock_logger.info.assert_any_call(
            "Processing all .tf files in folder: /test/folder"
        )
    ...
    @patch("src.hcl_processor.main.setup_logger")
    @patch("src.hcl_processor.main.reset_markdown_file")
    def test_main_folder_deterministic_processing_order(
        self,
        mock_reset_markdown,
        mock_setup_logger,
        mock_workflow,
        ...
        expected_calls = [
            ...
            call(
                "/test/folder/subdir/xxx.tf", folder_config, self.sample_system_config
            ),
            call(
                "/test/folder/subdir/yyy.tf", folder_config, self.sample_system_config
            ),
    ...
    @patch("src.hcl_processor.main.setup_logger")
    @patch("src.hcl_processor.main.reset_markdown_file")
    def test_main_folder_consistent_ordering_multiple_runs(
        self,
        mock_reset_markdown,
        mock_setup_logger,
        mock_workflow,
    ...
    @patch("src.hcl_processor.main.load_system_config")
    @patch("src.hcl_processor.main.load_config")
    def test_main_config_failure(
        self, mock_load_config, mock_load_system_config, mock_parse_args
    ):
    ...
    @patch("src.hcl_processor.main.os.walk")
    @patch("src.hcl_processor.main.setup_logger")
    def test_main_bedrock_errors_outside_loop(
        self,
        mock_setup_logger,
        mock_walk,
        mock_load_config,
    ...
    @patch("src.hcl_processor.main.os.walk")
    @patch("src.hcl_processor.main.setup_logger")
    def test_main_unknown_exception_outside_loop(
        self,
        mock_setup_logger,
        mock_walk,
        mock_load_config,
    ...
    @patch("src.hcl_processor.main.run_hcl_file_workflow")
    @patch("src.hcl_processor.main.setup_logger")
    def test_main_individual_file_errors_are_caught(
        self,
        mock_setup_logger,
        mock_workflow,
        mock_load_config,
        ...
        test_errors = [
            ...
            ClientError(
                {"Error": {"Code": "TestError", "Message": "Test"}}, "test_operation"
            ),
    ...
    @patch("src.hcl_processor.main.run_hcl_file_workflow")
    @patch("src.hcl_processor.main.setup_logger")
    def test_main_file_processing_with_errors(
        self,
        mock_setup_logger,
        mock_workflow,
        mock_load_config,
        ...
        multiple_files_config["input"]["resource_data"]["files"] = [
            "test1.tf",
            "test2.tf",
            "test3.tf",
        ]
    ...
    @patch("src.hcl_processor.main.load_config")
    @patch("src.hcl_processor.main.setup_logger")
    def test_main_no_files_or_folder(
        self,
        mock_setup_logger,
        mock_load_config,
        mock_load_system_config,
